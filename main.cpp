...
int main() {
    ...
    myJSON2File("test.txt", &first);
    myJSON2File("test.txt", &second);
    myJSON2File("test.txt", &third);
    myJSON2File("test.txt", &fourth);
    ...
    myFile2JSON("test.txt", &newFirst);
    myFile2JSON("test.txt", &newSecond);
    myFile2JSON("test.txt", &newThird);
    myFile2JSON("test.txt", &newFourth);
